...
<body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
                ...
                <div class="page-actions">
                    <div class="btn-group">
                        <button type="button" class="btn red-haze btn-sm dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                            <span class="hidden-sm hidden-xs">Managements&nbsp;</span>
                            <i class="fa fa-angle-down"></i>
                        </button>
                        <ul class="dropdown-menu" role="menu">
                            <li>
                                <a href="#">
                                    <i class="icon-docs"></i> Tickets Management </a>
                            </li>
                            <li>
                        </ul>
                    </div>
    ...
    <!--
    <script src="{{ url('js/plugins/canvas-to-blob.min.js') }}"></script>
    <script src="{{ url('js/plugins/sortable.min.js') }}"></script>
    <script src="{{ url('js/plugins/purify.min.js') }}"></script>
    <script src="{{ url('js/fileinput.js') }}"></script>
    <script src="{{ url('js/locales/th.js') }}"></script>
    -->
